...
class VisualGenomeDataset(Dataset):
    ...
    '''
    def __init__(self, scene_graph_json, image_data_json,transform=None, pre_transform=None, pre_filter=None):
        ...
        self.colour_whitelist = ['red', 'blue', 'green', 'yellow', 'white', 'silver', 'pink', 'purple'] # some objects have colour attributes
        ...
        self.image_id_to_url = {} # map image id to url (so that we can retrieve the actual image)
        self.image_id_to_size = {} # map image id to size (FUTURE: could need to revert image to original size)

        self.scene_graph_array = [] # array to store all scene graphs from scene_graph json
